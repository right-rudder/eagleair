...
// aircraft
<BaseLayout
  siteTitle={`Training Aircraft Fleet | ${COMPANY_NAME}`}
  siteDescription={`Explore the modern and reliable training aircraft used for pilot training at ${COMPANY_NAME}.`}
>
...
<BaseLayout
  siteTitle={`Discovery Flight Confirmation | ${COMPANY_NAME}`}
  siteDescription={`Your discovery flight at ${COMPANY_NAME} is confirmed. We look forward to flying with you.`}
>

// enrollment
<BaseLayout
  siteTitle={`Enroll in Flight Training | ${COMPANY_NAME}`}
  siteDescription={`Enroll in professional flight training at ${COMPANY_NAME} and begin your journey to becoming a pilot.`}
>

// enrollmentConfirmation
<BaseLayout
  siteTitle={`Enrollment Confirmed | ${COMPANY_NAME}`}
  siteDescription={`Your enrollment with ${COMPANY_NAME} has been received. Our team will contact you shortly.`}
>
...
<BaseLayout
  ...
  siteDescription={`New to aviation? Learn how to become a pilot with structured flight training at ${COMPANY_NAME}.`}
>
...
<BaseLayout
  siteTitle={`Airline Transport Pilot (ATP) Pathway | ${COMPANY_NAME}`}
  siteDescription={`Learn about ATP requirements and airline pilot pathways through ${COMPANY_NAME}.`}
>
...
// studentResources
<BaseLayout
  siteTitle={`Student Pilot Resources | ${COMPANY_NAME}`}
  siteDescription={`Access important resources and documents for student pilots training at ${COMPANY_NAME}.`}
>
...
// blogWhyBecomePilot
<BaseLayout
  siteTitle={`Why Become a Pilot? | ${COMPANY_NAME} Blog`}
  siteDescription={`Discover why becoming a pilot is a rewarding career and how ${COMPANY_NAME} helps students succeed.`}
>

// blogDropout
<BaseLayout
  siteTitle={`Why Student Pilots Drop Out | ${COMPANY_NAME} Blog`}
  siteDescription={`Learn why many student pilots quit flight training and how ${COMPANY_NAME} helps you finish.`}
>
...
// notFound
<BaseLayout
  siteTitle={`Page Not Found | ${COMPANY_NAME}`}
  siteDescription={`The page you're looking for could not be found. Explore flight training programs at ${COMPANY_NAME}.`}
>

// serverError
<BaseLayout
  siteTitle={`Server Error | ${COMPANY_NAME}`}
  siteDescription={`Something went wrong on our end. Please try again or return to ${COMPANY_NAME}.`}
>

// privacyPolicy
<BaseLayout
  siteTitle={`Privacy Policy | ${COMPANY_NAME}`}
  siteDescription={`Review how ${COMPANY_NAME} collects, uses, and protects your personal information.`}
>
